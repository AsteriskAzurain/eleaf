		...
		<ul class="message-r">
			...
			<div class="topMessage my-shangcheng">
				<div class="menu-hd MyShangcheng">
					<a href="../person/index.html" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a>
				</div>
			</div>
	...
	<div class="search">
		<div class="search-list">
					...
					<div class="theme-popover">
						<ul class="select">
							<p class="title font-normal">
								<span class="fl">${likename }</span> <span class="total fl">搜索到<strong
									class="num">${num }</strong>件相关商品
								</span>
							</p>
							<div class="clear"></div>
						...
						<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
							<c:forEach items="${list}" var="ginfo">
								...
								<div class="i-pic limit">
									...
									<p class="title fl">${ginfo.goods_name }</p>
									<p class="price fl">
										<b>¥</b> <strong>${ginfo.goods_price }</strong>
									</p>
									<p class="number fl">
										销量<span>${ginfo.goods_buy_count }</span>
									</p>
								</div>
							</li>
							</c:forEach>
			...
			<div class="footer ">
				<div class="footer-bd ">
					<p>
						<em>Copyright &copy; 2019. eLeaf Group8301 All rights
							reserved.</em>
					</p>
				</div>
			</div>
