...
<body>
					...
					<div class="col">
						<div class="row-lg-6 mb-4">
							<div class="card">
								...
								<div class="card-body">
									<form action="/eleaf/goods/info/updateRecord">
										<fieldset>
											<legend>修改商品信息</legend>
											<div class="form-group mt-4">
												<label for="InputTypeName">商品id</label> 
												<input name="id" id="ShowId" type="text" class="form-control" readonly="readonly" value="${param.id }${requestScope.record.id}">
											</div>
											
											<div class="form-group mt-4">
												<label for="InputGoodsName">商品名</label> 
												<input name="goods_name" id="InputGoodsName" type="text"
													placeholder="输入商品名" class="form-control" value="${record.goods_name }">
											</div>
											<div class="form-group mt-4">
												<label for="InputGoodsDesc">商品描述</label> 
												<textarea name="goods_description" id="InputGoodsDesc" rows="5" cols="" placeholder="输入商品描述" class="form-control mb-5">${record.goods_description }</textarea>
											</div>
											<div class="form-group mt-4">
												<div class="form-group row">
													<div class="col-md-6">
														...
														<div class="input-group">
															...
															<input name="goods_price" type="text" class="form-control" placeholder="输入商品单价" value="${record.goods_price }">
														</div>
													</div>
													<div class="col-md-6">
														...
														<div class="input-group">
															...
															<input name="goods_cost" type="text" class="form-control" placeholder="输入商品成本" value="${record.goods_cost }">
														</div>
													</div>
												</div>
											</div>
	...
	<script src="../js/front.js"></script>
		...
		var hiddenflag=${record.hiddenFlag}
		console.info(hiddenflag)
		if (hiddenflag == 1) {
			$("#customRadio1").attr("checked", "checked");
			$("#customRadio0").removeAttr("checked");
		} else {
			//非默认店铺
			$("#customRadio0").attr("checked", "checked");
